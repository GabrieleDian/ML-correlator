...
rungrulegenerate[fGraphListcan[6]]


(* ::Subsubsection:: *)
(*9 loop from 10 loops*)


gWithCoeff=Thread[{fGraphListcan[nn],amplitudeCoefficients[nn]}];


result=generateRungWithCoeff[gWithCoeff];
