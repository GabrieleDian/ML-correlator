...
\begin{document}
	...
	\end{itemize}
	%	
	The $n$-point correlator is given by a linear combination with rational coefficients of f-graphs. For example the 8-point correlator is given by
	%
	\begin{center}
		\includegraphics[scale=1.2]{4loop.pdf}
	\end{center}
	%
	The space of f-graphs at 6 and 7 points is one dimensional. From 8-point the space is non-trivial and at 9-point the first f-graphs with a zero coefficient start appearing. At 14-point graphs with zero coefficient become the majority and this percentage keeps growing with the number of points.
...
\begin{table}[h!]
	...
	\begin{tabular}{|c|r|r|r|}
		\hline
		\multicolumn{4}{|c|}{\textbf{Solid graph}} \\
		\hline
		\textbf{Loop} & \textbf{Total} & \textbf{\#1} & \textbf{\#0} \\
		\hline
		7  & 164     & 107    & 57 \\
