    ...
    *,
    ...
    def objective(**params):
        ...
        try:
            ...
            for idx, (train_loops, val_loops) in enumerate(validation_splits, 1):
                ...
                auc = _fit_eval_split(train_loops, val_loops, params)
                if not np.isnan(auc):
    ...
    if cfg.test_loop is not None:
        ...
        if not np.any(test_mask):
            ...
            logging.info(f"Test AUC saved to: {test_auc_path}")
            print(f"Test AUC saved to: {test_auc_path}", flush=True)
