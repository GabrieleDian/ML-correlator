from modelling_function_12_ts_lp1_reweighting_reopt import BayesConfig, setup_logging, run_bayes_on_merged_parquet
import json
...
runs = [
    # Run 1: Train on [5,6,7], test on loop 8 with validation_step=[1]
    {
        ...
        "test_loop": 8,
        "validation_step": [1],
        "label": "reopt2_train_567_test8_vstep1"
    },
    # Run 2: Train on [5,6,7], test on loop 9 with validation_step=[1]
    {
        ...
        "test_loop": 9,
        "validation_step": [1],
        "label": "reopt2_train_567_test9_vstep1"
    },
    # Run 3: Train on [5,6,7,8], test on loop 9 with validation_step=[1]
    {
        ...
        "test_loop": 9,
        "validation_step": [1],
        "label": "reopt2_train_5678_test9_vstep1"
    },
    # Run 5: Train on [5,6,7,8], test on loop 10 with validation_step=[1]
    {
        ...
        "test_loop": 10,
        "validation_step": [1],
        "label": "reopt2_train_5678_test10_vstep1"
    },
    ...
    # Run 7: Train on [5,6,7,8,9], test on loop 10 with validation_step=[1]
    {
        ...
        "test_loop": 10,
        "validation_step": [1],
        "label": "reopt2_train_56789_test10_vstep1"
    },
    # Run 9: Train on [5,6,7,8,9], test on loop 11 with validation_step=[1]
    {
        ...
        "test_loop": 11,
        "validation_step": [1],
        "label": "reopt2_train_56789_test11_vstep1"
    },
    # Run 11: Train on [5,6,7,8,9,10], test on loop 11 with validation_step=[1]
    {
        ...
        "test_loop": 11,
        "validation_step": [1],
        "label": "reopt2_train_5678910_test11_vstep1"
    },
    # Run 13: Train on [5,6,7,8,9,10,11] without test, validation_step=[1]
    {
        ...
        "test_loop": None,
        "validation_step": [1],
        "label": "reopt2_train_567891011_notest_vstep1"
    },
]
