...
\end{equation}
	...
	Another binary rule we can extract from~\eqref{ceqn} occurs when the left hand side vanishes and the right hand side has just two terms, so $d=6$, $d_1=d_2=5$. This occurs whenever  there is a double triangle with two degree 5 vertices at the top and the bottom and no numerator edge from left to right. We have	
	...
	As we have previously noted,the numerator ends can be conected to the central vertices and  hence remove edges. So eg if $A$ and $B$ coincide with the upper and lower right vertex, this equation would read: 
	% 
	\[\begin{tikzcd}[sep=small]
		& \bullet &&&& A &&&&&& \bullet &&&& A \\
		\\
...
\section{New binary rules from the cusp rule}

One can derive a new $l \rightarrow l+1$ binary rule from the cusp rule. If the central node on the LHS of the cusp rule~\eqref{cusp} has numerators all ending at a single node (ie the set $S$ consists of only one node)  then the RHS will consist of only a single diagram:
% https://q.uiver.app/#q=
\[\begin{tikzcd}
	&&& \bullet &&&&&&&&& {} \\
	& \bullet &&&& \bullet &&&&& \bullet &&&& \bullet \\
	\bullet &&&&&& \bullet &&& \bullet &&&&&& \bullet \\
	...
	\arrow[no head, from=3-16, to=5-16]
	\arrow[no head, from=4-13, to=5-16]
	\arrow[curve={height=-6pt}, equals, dashed, from=4-13, to=5-17]
	\arrow[no head, from=4-13, to=6-13]
	\arrow[no head, from=5-1, to=3-1]
	\arrow[no head, from=5-1, to=5-4]
	\arrow[no head, from=5-1, to=7-1]
	...
	\arrow[no head, from=5-16, to=6-13]
	\arrow[no head, from=6-13, to=5-10]
	\arrow[curve={height=6pt}, equals, dashed, from=6-13, to=5-17]
	\arrow[no head, from=6-13, to=7-16]
	\arrow[no head, from=6-13, to=8-15]
	\arrow[no head, from=6-13, to=9-13]
	\arrow[no head, from=7-1, to=5-4]
	...
	\arrow[no head, from=9-13, to=8-15]
\end{tikzcd}\]
This gives a new type of rung rule. Note that the vertex on which teh numerators end could be one of the vertices around the edge in which case one of the edges will be missing. The first time this gives a new result, with non zero coefficient, not derivable by the square rule is at 7 loops.
